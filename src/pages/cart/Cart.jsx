...
function Cart() {
  ...
  const deleteCart = (item) => {
    ...
    toast.success('deleted a cart item');
  }
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_oOcb7BVhe0dOsO",
      key_secret: "bGEAnVnG6Wceu51bVwHbokq2",
              ...
              return (
                <div className="justify-between mb-6 rounded-lg border  drop-shadow-xl bg-white p-6  sm:flex  sm:justify-start" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
                  ...
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                    ...
                    <div onClick={()=> deleteCart(item)} className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6 text-red-600">
